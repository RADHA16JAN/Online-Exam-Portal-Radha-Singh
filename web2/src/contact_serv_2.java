...
public class contact_serv_2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		contact_serv_2 email = new contact_serv_2();
	     //Sending test email
	      email.createAndSendEmail("pankaj95484636@gmail.com", "Online Exam Portal",t_message );
	}
	...
	private void sendEmailMessage() {
	  ...
	  try {
	    ...
	    message.setRecipients(Message.RecipientType.TO,InternetAddress.parse("pankaj95484636@gmail.com")); //Set email recipient
