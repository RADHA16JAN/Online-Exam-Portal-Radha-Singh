            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="img/ronak.jpg" alt="" style="width: 40px; height: 40px;">
                ...
                <div class="navbar-nav w-100">
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="users.jsp" rel="sponsored" class="external"> Insert Profile</a>
                            <a href="usersupdate.jsp" class="dropdown-item">Update Profile</a>
                            <a href="usersdelete.jsp" class="dropdown-item">Delete Profile</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="findsubject.jsp" class="dropdown-item">Update Subject</a>
                    ...
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Add Exam Ques</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="exam.jsp" class="dropdown-item" name="ones">Java Questions</a>
                            <a href="exam.jsp" class="dropdown-item" name="ones">Python Questions</a>
                            <a href="exam.jsp" class="dropdown-item" name="ones">Node.js Questions</a>
                            <a href="exam.jsp" class="dropdown-item" name="ones">${Name} Questions</a>
                        </div>
                    </div>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <a href="addadmin.jsp" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Add Admin</a>
                        </div>
                        <div class="nav-item nav-link">
                    <a href="adduser.jsp" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Add User</a>
                        </div>
                    <div class="nav-item nav-link">
                    <a href="aboutus.jsp"class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>About Us</a>
                        </div>
                    <div class="nav-item nav-link">
                    <a href="contact_us.jsp" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Contact Us</a>
                        </div>
